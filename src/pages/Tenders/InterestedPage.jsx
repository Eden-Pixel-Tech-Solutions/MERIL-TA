...
import '../../assets/css/InterestedPage.css';

const DUMMY_INTERESTED = [
  { T_ID: 'T001', title: 'Construction of Municipal Building', startDate: '2024-01-15', endDate: '2025-01-30', department: 'PWD', location: 'Mumbai', state: 'Maharashtra', value: 41600, emd: 10000000, qty: 1, status: 'Open', interested: true },
  { T_ID: 'T003', title: 'Water Supply Pipeline Installation', startDate: '2024-01-20', endDate: '2025-01-25', department: 'Water Board', location: 'Bangalore', state: 'Karnataka', value: 15200, emd: 3000000, qty: 10, status: 'Open', interested: true },
  { T_ID: 'T006', title: 'Bridge Construction and Maintenance', startDate: '2024-01-25', endDate: '2025-02-05', department: 'PWD', location: 'Hyderabad', state: 'Telangana', value: 55000, emd: 12000000, qty: 2, status: 'Open', interested: true },
  { T_ID: 'T008', title: 'IT Infrastructure Upgrade', startDate: '2024-02-15', endDate: '2025-02-25', department: 'Technology', location: 'Ahmedabad', state: 'Gujarat', value: 12000, emd: 2500000, qty: 1, status: 'Open', interested: true },
  { T_ID: 'T009', title: 'Public Transport Bus Procurement', startDate: '2024-01-30', endDate: '2025-02-10', department: 'Transport', location: 'Jaipur', state: 'Rajasthan', value: 45000, emd: 9000000, qty: 25, status: 'Open', interested: true },
  { T_ID: 'T011', title: 'Solar Panel Installation Project', startDate: '2024-02-20', endDate: '2025-03-01', department: 'Energy', location: 'Lucknow', state: 'Uttar Pradesh', value: 22000, emd: 4500000, qty: 100, status: 'Open', interested: true },
  { T_ID: 'T012', title: 'Sports Complex Development', startDate: '2024-03-15', endDate: '2025-03-25', department: 'Sports', location: 'Kanpur', state: 'Uttar Pradesh', value: 18500, emd: 3800000, qty: 1, status: 'Open', interested: true },
  { T_ID: 'T015', title: 'Metro Rail Extension Project', startDate: '2024-02-05', endDate: '2025-02-28', department: 'Transport', location: 'Mumbai', state: 'Maharashtra', value: 78000, emd: 15000000, qty: 1, status: 'Open', interested: true },
  { T_ID: 'T018', title: 'Smart City Development Initiative', startDate: '2024-03-01', endDate: '2025-03-20', department: 'Urban Dev', location: 'Pune', state: 'Maharashtra', value: 62000, emd: 13000000, qty: 1, status: 'Open', interested: true },
  { T_ID: 'T021', title: 'Water Treatment Plant Upgrade', startDate: '2024-01-10', endDate: '2025-02-15', department: 'Water Board', location: 'Chennai', state: 'Tamil Nadu', value: 34000, emd: 7000000, qty: 2, status: 'Open', interested: true },
  { T_ID: 'T024', title: 'Airport Terminal Expansion', startDate: '2024-02-20', endDate: '2025-03-10', department: 'Aviation', location: 'Delhi', state: 'Delhi', value: 95000, emd: 19000000, qty: 1, status: 'Open', interested: true },
  { T_ID: 'T027', title: 'Educational Technology Implementation', startDate: '2024-03-05', endDate: '2025-03-18', department: 'Education', location: 'Bangalore', state: 'Karnataka', value: 14500, emd: 3000000, qty: 150, status: 'Open', interested: true }
];
...
export default function InterestedPage() {
  ...
  const [tenders, setTenders] = useState(DUMMY_INTERESTED);
  ...
  return (
    <div className="interested-page">
      ...
      <div className="sort-section">
        <div className="results-count">{sortedTenders.length} interested tenders found</div>
      ...
      {sortedTenders.length === 0 && (
        <div className="no-results">
          No interested tenders found matching your filters.
        </div>
      )}
